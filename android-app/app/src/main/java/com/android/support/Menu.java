...
public class Menu {
    ...
    int MENU_BG_COLOR = Color.parseColor("#90656565"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#90656565"); //#AARRGGBB
    int MENU_WIDTH = 250;
    int MENU_HEIGHT = 210;
    int POS_X = 0;
    int POS_Y = 100;
    int x1 = Color.parseColor("#000000");
    int x2 = Color.parseColor("#b7c0d7");
    int x3 = Color.WHITE;
    ...
    int CategoryBG = Color.parseColor("#2fff37");
    int SeekBarColor = Color.parseColor("#00fb31");
    int SeekBarProgressColor = Color.parseColor("#00fb31");
    int CheckBoxColor = Color.parseColor("#80CBC4");
    int RadioColor = Color.parseColor("#FFFFFF");
    String NumberTxtColor = "#10e0f4";
    //********************************************************************//
    ...
    public Menu(Context context) {
        ...
        mExpanded.setPadding(10, 0, 10, 0); //So borders would be visible
        ...
        gdMenuBody.setCornerRadii(new float[]{(float) 80, (float) 80, (float) 80, (float) 80, (float) 80, (float) 80, (float) 80, (float) 80});
        gdMenuBody.setStroke(8, this.x1);
      //  hideBtn.setBackground(gdMenuBody);
    ...
    //    mExpanded.setBackground(gdMenuBody); //Apply GradientDrawable to it
     ...
     //   settings.setText(Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M ? "⚙" : "\uD83D\uDD27");
        ...
        titleText.setPadding(10, 22, 10, 6);


        titleText.setElevation((float) 3);

        //titleText.setVerticalGravity(16);
        TextView title = new TextView(context);
        title.setTypeface(null, Typeface.BOLD);
        title.setTextColor(this.ToggleON);
        title.setTextSize(20.0f);
        title.setShadowLayer(5, 0, 0, -16777216);
        title.setPadding(20, 6, 20, 12);
        title.setShadowLayer(10, 5, 5, Color.parseColor("#000000"));
        title.setGravity(17);
        ...
        gradientDrawable2.setColor(this.x2);
        gradientDrawable2.setCornerRadii(new float[]{-10.0f, -20.0f, -10.0f, -20.0f, 30.0f, 70.0f, 30.0f, 70.0f});
        gradientDrawable2.setStroke(6, x1);
        title.setBackground(gradientDrawable2);
        ...
        relativeLayout.setPadding(20, 25, 20, 25);
        ...
        hideBtn.setTextColor(x3);
        hideBtn.setTextSize(14.0f);
        
        gdMenuBody = new GradientDrawable();
        gdMenuBody.setColor(this.x2);
        gdMenuBody.setCornerRadii(new float[]{(float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 85, (float) 85});
        gdMenuBody.setStroke(8, this.x1);
        hideBtn.setBackground(gdMenuBody);
        ...
        closeBtn.setTextColor(x3);
      
       
        gdMenuBody = new GradientDrawable();
        gdMenuBody.setColor(this.x2);
        gdMenuBody.setCornerRadii(new float[]{(float) 0, (float) 0, (float) 0, (float) 0, (float) 85, (float) 85, (float) 0, (float) 0});
        gdMenuBody.setStroke(8, this.x1);
        closeBtn.setBackground(gdMenuBody);
    ...
    private void Switch(LinearLayout linLayout, final int featNum, final String featName, boolean swiOn) {
        final android.graphics.drawable.GradientDrawable GD_THUMB= new  android.graphics.drawable.GradientDrawable();
        GD_THUMB.setSize(50, 50);
        GD_THUMB.setShape(1);
        GD_THUMB.setStroke(3, Color.parseColor("#000000")); // bo tròn off
        GD_THUMB.setColor(Color.parseColor("#f20004")); //MAIN OFFF

        final android.graphics.drawable.GradientDrawable GD_TRACK = new android.graphics.drawable.GradientDrawable();
        GD_TRACK.setSize(35, 5);
        GD_TRACK.setCornerRadius(80);
        GD_TRACK.setStroke(5, Color.parseColor("#000000"));//màu viền
        GD_TRACK.setColor(Color.parseColor("#ffffff")); //

        final Switch switchR = new Switch(getContext);
        switchR.setText(featName);
        switchR.setTextColor(TEXT_COLOR_2);
        switchR.setShadowLayer(7,0,0,Color.parseColor("#ffffff"));
        switchR.setTextSize(14);
        switchR.setPadding(10, 10, 20, 10);
        ...
        switchR.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean bool) {
                    if (bool) {
                        GD_THUMB.setStroke(3, Color.parseColor("#000000")); //màu bo tròn ON
                        GD_THUMB.setColor(Color.parseColor("#00fb1b")); // Main ON

                        GD_TRACK.setStroke(5, Color.parseColor("#000000")); // màu viền
                        GD_TRACK.setColor(Color.parseColor("#ffffff")); // BG
                    } else {
                        GD_THUMB.setStroke(3, Color.parseColor("#000000")); // bo tròn OFF
                        GD_THUMB.setColor(Color.parseColor("#f20004"));

                        GD_TRACK.setStroke(5, Color.parseColor("#000000")); //Viền OFF
                        GD_TRACK.setColor(Color.parseColor("#ffffff"));
                    }
    ...
    private void SeekBar(LinearLayout linLayout, final int featNum, final String featName, final int min, int max) {
        ...
        textView.setTextColor(Color.parseColor("#10e0f4"));
        textView.setShadowLayer(7,0,0,Color.parseColor("#18f3ff"));
    ...
    private void ButtonLink(LinearLayout linLayout, final String featName, final String url) {
        ...
        button.setLayoutParams(layoutParams);
        button.setAllCaps(false); //Disable caps to support html
        button.setTextColor(ToggleON);
        button.setText(Html.fromHtml(featName));
        button.setBackgroundColor(BTN_COLOR);
       
        GradientDrawable gradientDrawable1 = new GradientDrawable();
        gradientDrawable1.setCornerRadius (30);
        gradientDrawable1.setColor(Color.parseColor("#00000000")); //BG
        gradientDrawable1.setStroke(5,ToggleON);
        button.setBackground(gradientDrawable1);
        button.setShadowLayer(7,0,0,ToggleON);  
    ...
    private void TextView(LinearLayout linLayout, String text) {
        ...
        textView.setText(Html.fromHtml(text));
        textView.setTextColor(TEXT_COLOR_2);
        textView.setShadowLayer(7,0,0,SeekBarColor);
