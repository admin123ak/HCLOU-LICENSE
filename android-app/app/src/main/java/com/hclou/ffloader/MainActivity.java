...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle s) {
        ...
        prefs    = getSharedPreferences("hclou_ff", MODE_PRIVATE);
    ...
    private void doLogin() {
        ...
        new AsyncTask<String, Void, String>() {
            @Override protected String doInBackground(String... a) {
                try { return jniLogin(a[0], a[1], a[2]); }
                catch (Throwable t) { return "NATIVE_FAIL: " + t.getMessage(); }
            }
            @Override protected void onPostExecute(String reason) {
    ...
    private void startMod() {
        ...
        toast("Đã khởi động mod. Mở Free Fire để chạy.");
        moveTaskToBack(true);
    }
    ...
    private String computeSerial() {
        try {
            ...
            String seed = (androidId == null ? "" : androidId) + "|" + Build.MODEL + "|" + Build.BRAND;
