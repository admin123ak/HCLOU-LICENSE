...
/**
 * Floating mod menu service.
 * Sau khi login OK, MainActivity startService → service tạo floating window
 * hiển thị modname + button Toggle bypass / Start mod thread.
 */
public class ModService extends Service {
    ...
    private void startForegroundCompat() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String chId = "hclou_mod";
            NotificationChannel ch = new NotificationChannel(chId, "HCLOU Mod",
                NotificationManager.IMPORTANCE_LOW);
            nm.createNotificationChannel(ch);
            Notification n = new Notification.Builder(this, chId)
                .setContentTitle("HCLOU Mod active")
    ...
    private void showFloating() {
        ...
        floatingView.findViewById(R.id.btnToggleBypass).setOnClickListener(v -> {
            ...
            Toast.makeText(this, "Bypass: " + (bypassOn ? "ON" : "OFF"), Toast.LENGTH_SHORT).show();
        });
